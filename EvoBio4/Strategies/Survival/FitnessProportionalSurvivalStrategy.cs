...
{
	public class FitnessProportionalSurvivalStrategy : StrategyBase, ISurvivalStrategy
	{
		public override string Description => "Choose N-1 survivors with probability proportional to fitness";
