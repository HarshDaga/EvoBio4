...
{
	public class FitnessInverselyProportionalSurvivalStrategy : StrategyBase, ISurvivalStrategy
	{
		public override string Description => "Choose 1 victim with probability inversely proportional to fitness";
